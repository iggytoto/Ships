...
namespace Services.Ecs.Systems
{
    ...
    public partial struct GoInGameClientSystem : ISystem
    {
        ...
        {
            Debug.Log("UPDATE: client system update");
    ...
    public partial struct GoInGameServerSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
            Debug.Log("UPDATE: server system update");
                ...
                .WithEntityAccess())
            {
                ...
                Debug.Log($"'{worldName}' setting connection '{networkId.Value}' to in game, spawning a Ghost");
                //
